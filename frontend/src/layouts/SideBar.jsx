  ...
  return (
    ...
    >
      ...
      {dataSideBar && dataSideBar.length > 0 && (
        <div
          className={`z-15 bg-dark bg-gray-200 shadow-lg font-[Poppins,sans-serif] w-[80%] 2xl:w-[17%] md:w-[250px] flex flex-col pl-1 absolute sm:translate-x-0 duration-500 ${
      ...
      <div className="sm:relative md:pl-[150px] w-full md:w-[86%]">
        <Outlet />
      </div>
    </div>
  );
