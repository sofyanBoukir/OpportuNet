...
export const Login = () => {
  ...
  const [emailNotVerified, setEmailNotVerified] = useState(
    localStorage.getItem("emailNotVerified") || ""
  );
  ...
  return (
    <div>
          ...
          <div className="w-[60%] h-screen md:block hidden relative">
            ...
            <div className="absolute inset-0 px-32 py-20 text-white bg-opacity-40 mt-28">
              <div className="flex items-center min-h-[200px] gap-4">
                ...
                <div>
                  <h1 className="text-6xl font-bold 2xl:text-7xl">
                    Welcome to
                  </h1>
              ...
              <div className="mt-10 w-[90%]">
                <p className="text-lg font-medium 2xl:text-2xl">
                  OpportuNet connects professionals, helping them grow and find
                  new opportunities. Build your network, showcase your skills,
          ...
          <div className="md:w-[40%] w-[100%] bg-gray-100 h-[100vh] pt-20">
            <div className="mt-6 w-[70%] mx-auto">
              ...
              <p className="text-gray-500 font-semibold mt-2">
                ...
                <Link className="underline text-black" to={"/user/sign_up"}>
                  Create account
                </Link>
                <br></br>
      ...
      {emailNotVerified === "true" && (
        <VerifyCode setClose={setEmailNotVerified} />
      )}
