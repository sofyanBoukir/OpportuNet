      ...
      <div className="flex justify-between">
        <div className="w-[60%] h-screen md:block hidden relative">
          ...
          <div className="absolute inset-0 flex px-32 flex-col py-20 text-white  bg-opacity-40">
            ...
            <h1 className="text-6xl font-bold 2xl:text-7xl mt-6">
              OpportuNet!
            </h1>
            <div className="mt-10 w-[70%]">
              <p className="text-lg font-medium 2xl:text-2xl">
                OpportuNet connects professionals, helping them grow and find
                new opportunities. Build your network, showcase your skills, and
                advance your career{" "}
              </p>
            </div>
          </div>
        ...
        <div className="md:w-[40%] w-[100%] bg-gray-100 h-[100vh] pt-20">
          <div className="mt-6 w-[70%] mx-auto">
            ...
            <p className="text-gray-500 font-semibold mt-2">
              ...
              <Link className="underline text-black">Create account</Link>
              <br></br>
            ...
            <div className="mt-8 flex flex-col gap-3">
              ...
              <p className="text-gray-500 font-semibold mt-2 text-center">
                forget password{" "}
                <Link className="underline text-black">Click here</Link>
                <br></br>
              </p>
            </div>
          </div>
