...
export const SuggestionsModal = ({ suggestionList }) => {
  ...
  return (
    <div>
      {
        !loading && <div className="p-3 bg-white w-full lg:w-full lg:rounded-lg z-10">
                    <h1 className="text-xl font-semibold">People you may know</h1>
                    <span className="text-gray-500">Based on your interests</span>
                    {suggestionList.map((item) => (
                      <div className="p-2 w-full flex gap-2 items-center mt-2 relative border-b border-b-gray-300">
                        <div>
                          <img
                        ...
                        <div>
                          ...
                          <Follow type={'text'} text={'follow'} className={'bg-inherit hover:bg-gray-100 duration-200 rounded-full font-semibold border-2 border-gray-500 text-gray-600'}/>
                        </div>
                      </div>
                    ))}
                  </div>
