...
export const Conversation = ({conversation,setSelectefConversation,setOtherParticipiant}) => {
  ...
  return (
    <>
        <div onClick={() => {setSelectefConversation(conversation);setOtherParticipiant(otherParticipant)}} className='dark:hover:bg-gray-900 px-3 py-1 lg:flex items-center lg:text-start text-center lg:justify-between cursor-pointer duration-200 hover:bg-gray-100'>
            <div className='lg:flex gap-3 items-center'>
                ...
                <div>
                    ...
                    <span className={`hidden lg:block ${conversation.lastMessageStatus === 'sent' && conversation.lastMessageSender !== userData._id ? 'font-semibold text-black dark:text-white' : 'text-gray-600 '}`}>{conversation.lastMessage.substr(0,20)}...</span>
                </div>
            </div>
            <div>
