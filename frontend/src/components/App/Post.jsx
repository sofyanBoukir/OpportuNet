...
export const Post = ({ post, showIcon, postSelected }) => {
  ...
  const _alreadyLiked = async () => {
    const response = await isAlreadyLiked(
    ...
    <div className="w-[100%] md:w-[100%] bg-white rounded-xl">
      ...
      <div>
        ...
        <div className="flex flex-row items-center py-2 px-5  justify-center">
          ...
          <button className="flex flex-row items-center w-[30%] hover:bg-gray-100 justify-center py-2 rounded-lg cursor-pointer duration-200">
            <div className="flex flex-row items-center gap-2">
