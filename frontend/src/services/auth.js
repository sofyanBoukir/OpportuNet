...
export const signedInButNotVerified = async (email) =>{
    const response = await axios.post(`${serverURL}/auth/signInNotVerified`,{email});
    return response;
}

export const checkVcode = async (email,vcode) =>{
    const response = await axios.post(`${serverURL}/auth/checkVCode`,{email,vcode});
    return response;
}

export const sendResetLink = async (email) =>{
    const response = await axios.post(`${serverURL}/auth/sendResetLink`,{email});
    return response;
}

export const resetPassword = async (formData) =>{
    const response = await axios.post(`${serverURL}/auth/resetPassword`,formData);
    return response;
}
