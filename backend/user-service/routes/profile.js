...
const { completeRegistration, updateInfo, updateAbout, getUserDataById, addEducation, updateEducation, deleteEducation, addExperience, updateExperience, deleteExperience, addSkill, deleteSkill, updateInterests } = require("../controllers/profile");
